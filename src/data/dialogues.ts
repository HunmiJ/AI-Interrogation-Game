...
export const dialogueOptions: DialogueOption[] = [
  {
    ...
    tone: 'evasive', unlockEvidenceId: 'camera-metadata', followUp: '谎言被拆穿，但滞留不等于盗窃。',
  },
  {
    id: 'jack-camera', npcId: 'jack', question: '把相机里的原片交给我。',
    response: '你会看到一些不该拍的东西。看第 184 张，玻璃上的倒影……时间是 23:09。那时 Tom 可不在楼上。',
    tone: 'tense', unlockEvidenceId: 'memory-card-photo', followUp: '相机捕捉到了案发时刻的关键人物。',
  },
  {
  ...
  },
  {
    ...
    tone: 'tense', unlockEvidenceId: 'transit-record', followUp: '她承认返回现场，但时间线可以外部验证。',
  },
  {
    id: 'alice-key', npcId: 'alice', question: '办公室备用钥匙还在你手上吗？',
    response: '上周盘点时借过，活动当天傍晚就还了。电子钥匙柜有记录。Tom 知道这件事，还特意问过我两次。',
    tone: 'defensive', unlockEvidenceId: 'key-return-log', followUp: '钥匙嫌疑减弱，但 Tom 对此异常关注。',
  },
  {
